...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("STVR", "gaemz", "com.example.myapp", "1000.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "MHOTGIBGJ", null, { width: 512, height: 384 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 512, height: 384 });
			#end

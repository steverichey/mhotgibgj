...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/lvl55.txt", "assets/data/lvl55.txt");
		type.set ("assets/data/lvl55.txt", AssetType.TEXT);
...
@:sound("C:/dev/flixel/assets/sounds/beep.ogg") class __ASSET__assets_sounds_beep_ogg extends flash.media.Sound {}
@:sound("C:/dev/flixel/assets/sounds/flixel.ogg") class __ASSET__assets_sounds_flixel_ogg extends flash.media.Sound {}

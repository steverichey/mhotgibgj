...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/lvl01.txt", __ASSET__assets_data_lvl01_txt);
		type.set ("assets/data/lvl01.txt", AssetType.TEXT);
...
@:keep class __ASSET__assets_data_lvl01_txt extends openfl.utils.ByteArray { }
...
@:file("assets/data/lvl01.txt") class __ASSET__assets_data_lvl01_txt extends flash.utils.ByteArray {}
